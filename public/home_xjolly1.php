...
<div class="container my-5">
    ...
    <div id="homeSlider" class="carousel slide mb-5 shadow rounded overflow-hidden" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img 
                    src="../assets/images/grill_burgers.jpg" 
                    class="d-block w-100 slider-only-image" 
            ...
            <div class="carousel-item">
                <img 
                    src="../assets/images/bacon_swiss_chicken.jpg" 
                    class="d-block w-100 slider-only-image" 
                    alt="Bacon and Swiss chicken sandwich"
                >
            </div>

            <div class="carousel-item">
                <img 
                    src="../assets/images/combo_meal.jpg" 
                    class="d-block w-100 slider-only-image" 
                    alt="Combo meal"
                >
            </div>
    ...
    <div class="row g-4 mb-5">
        <?php
        $categoryQuery = "SELECT * FROM Categories_JE20936 
                          WHERE status='Active' 
